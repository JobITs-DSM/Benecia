...
public class EnterpriseService {
    ...
    public EnterpriseInfoListResponse getEnterpriseInfoList() {
        return EnterpriseInfoListResponse.builder()
                .enterprises(enterpriseRepository.findAll()
                        .stream().map(enterprise -> EnterpriseInfoListResponse.EnterpriseInfo.builder()
                                .registrationNumber(enterprise.getRegistrationNumber())
                                .name(enterprise.getName())
                                .employeeCount(enterprise.getEmployeeCount())
                                .turnover(enterprise.getTurnover())
                                .division(enterprise.getDivision())
                                .businessArea(enterprise.getBusinessArea())
                                .isConvention(enterprise.getIsConvention())
                                .lastReceptionYear(enterprise.getLastReceptionYear())
                                .contractStudentCount(enterpriseRepository.getContractStudentCount(enterprise.getRegistrationNumber()))
                                .reviewCount(enterpriseRepository.getReviewCount(enterprise.getRegistrationNumber()))
                                .build()
    ...
    public EnterpriseInfoResponse getEnterpriseInfo(String registrationNumber) {
        ...
        return EnterpriseInfoResponse.builder()
                ...
                .businessAreas(enterprise.getBusinessArea())

...
@Getter
public class SimilarRecruitmentInfoListForStudentVO {
    ...
    @QueryProjection
    public SimilarRecruitmentInfoListForStudentVO(Integer hiringId, HiringAreaCode hiringCode, Integer recruitCount, String enterpriseName, String workPlace, List<String> tags, String enterpriseProfileImageUrl, String enterpriseBackgroundImageUrl) {
